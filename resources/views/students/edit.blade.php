...
<div class="pb-[20px]">
    <x-card class=" bg-white p-10 rounded-lg max-w-lg mx-auto mt-24 shadow-2xl">
        <header class="text-center">
            ...
            <p class="mb-4">Edit details of the student or go <a href="/" class="underline"> back </a></p>
        </header>
        <hr class="my-[20px]">
        <form method="POST" action="/students/{{ $student->id }}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input
                    type="text"
                    class="bg-gray-200 border border-gray-200 rounded p-2 w-full"
                    name="FSC" placeholder="Please enter the value without the % sign" value=" {{ $student->FSC }}"
                />
                @error('FSC')
                    <p class="text-red-500 text-xs mt-1">
                        @php
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    class="bg-gray-200 border border-gray-200 rounded p-2 w-full"
                    name="Matric"
                    placeholder="Please enter the value without the % sign" value=" {{ $student->Matric }}"
                />
                @error('Matric')
                    <p class="text-red-500 text-xs mt-1">
                        <p class="text-red-500 text-xs mt-1">
            ...
            <div class="mt-[50px] flex justify-between items-center">
                ...
                <a href="/" class="text-black hover:underline"> Back </a>
            </div>
